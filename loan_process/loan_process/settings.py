"""
Django settings for loan_process project.
...
SECRET_KEY = "django-insecure-q#ghulgp$6d&=fws)mzm3y-zh&*#$(msd2wa-x#pl3zo$+yysq"
...
ROOT_URLCONF = "loan_process.urls"
...
# Required for media file uploads (e.g. KYC docs)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Optional: CORS headers for React frontend
# CORS_ALLOW_ALL_ORIGINS = True  # Commented out to use specific origins instead

# JWT authentication (if using DRF SimpleJWT)
REST_FRAMEWORK = {
